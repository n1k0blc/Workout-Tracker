              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={set.reps || ''}
                      onChange={(e) =>
                        handleUpdateSet(setIdx, 'reps', parseInt(e.target.value) || 0)
                      }
                      min="1"
                      className="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={set.weight || ''}
                      onChange={(e) =>
                        handleUpdateSet(setIdx, 'weight', parseFloat(e.target.value) || 0)
                      }
                      min="0"
                      className="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={set.rir ?? ''}
                      onChange={(e) =>
                        handleUpdateSet(setIdx, 'rir', parseInt(e.target.value) || 0)
                      }
                      min="0"
                      max="10"
                      className="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div className="mt-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSet(setIdx, 'restAfterSet', parseInt(e.target.value) || 0)
                    }
                    min="0"
                    step="15"
                    className="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
